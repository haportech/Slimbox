...
import { TerminalSquare, Zap, Activity, DollarSign, ArrowRight, Clock } from 'lucide-react';
      ...
      <aside className="w-full md:w-64 border-b-2 md:border-b-0 md:border-r-2 border-foreground bg-card flex flex-col justify-between p-6 shrink-0">
        <div>
          ...
          <nav className="flex flex-col gap-4">
            <Link href="/" className="brutalist-button px-4 py-2">
              [DASHBOARD]
            </Link>
        ...
        <div className="text-xs text-muted-foreground mt-8 pb-8 break-all">
      ...
      <main className="flex-1 p-6 md:p-10 overflow-y-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
          ...
          <Card className="brutalist-card rounded-none">
            <CardHeader className="pb-2">
              <CardTitle className="text-sm uppercase text-muted-foreground flex justify-between">
                Latency Overhead <Clock className="w-4 h-4 text-accent" />
              </CardTitle>
            </CardHeader>
            <CardContent>
        ...
        <div>
          ...
          <Card className="brutalist-card rounded-none bg-background mr-2 mb-2">
